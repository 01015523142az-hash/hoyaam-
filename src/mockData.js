...
export const MOCK = {
  ...
  archive_corpus: [
    ...
    },
    {
      ...
      ai_summary: "إلغاء القرارات الإدارية السلبية لعيب إساءة استعمال السلطة والانحراف بها ومخالفة الاشتراطات البنائية والتخصيص الصناعي.",
      ai_precedents: "حكم المحكمة الإدارية العليا - الطعن رقم ١٨٢٣ لسنة ٥٤ ق.ع",
      ai_relevance: "يدعم الطعن الراهن في قضية د. هدى ضد وزارة الإسكان لإلغاء سحب التخصيص."
    },
    {
      id: "arch_805",
      matter_id: "mat_101",
      matter_title: "شركة النيل ضد الأهرام للمقاولات (٤١٢٩ / ٢٠٢٥)",
      document_name: "مذكرة_دفوع_بطلان_إعادة_الإعلان.pdf",
      page: 2,
      court: "محكمة استئناف القاهرة",
      doc_type: "مذكرات دفاع",
      date: "2025-11-04",
      snippet: "... الدفع بسقوط الخصومة لانقضاء الميعاد المنصوص عليه بالمادة ١٣٤ مرافعات دون إعادة إعلان الخصم بالصفة الصحيحة...",
      ai_summary: "الدفع ببطلان الإعلان وإعادة الإعلان إذا تم لغير ذي صفة أو دون استيفاء الشرائح البريدية أو إخطار جهة الإدارة خلال ٢٤ ساعة.",
      ai_precedents: "نقض مدني جلسة ١٢/٥/٢٠١٨ مجموعة الأحكام ص ٧٩",
      ai_relevance: "يصلح كدفع شكلي جوهري للدفاع عن شركة النيل."
    }
  ],
  ...
  templates: [
    {
      id: "tmpl_1",
      name: "صحيفة استئناف حكم مدني / تجاري",
      category: "صحف دعاوى وطعون",
      court_level: "استئناف عالي",
      description: "صحيفة استئناف شاملة أسباب البطلان الشكلي والخطأ في تطبيق القانون والفساد في الاستدلال.",
      template_content: `أنه في يوم {{day_name}} الموافق {{date}}
بناءً على طلب السيد / {{client_name}}، ومحله المختار مكتب الأستاذ / {{assigned_to}} المحامي بالاستئناف العالي ومجلس الدولة.

أنا _________ محضر محكمة _________ الجزئية قد انتقلت وأعلنت:
السيد / {{opponent_name}}، المقيم في {{opponent_address}}.
مخاطباً مع / ________________________________________________

الموضوع: استئناف الحكم الصادر في الدعوى رقم {{case_number}}
المقامة أمام {{court}} — {{circuit}}

الوقائع:
أقام المستأنف ضده ضد المستأنف الدعوى الصادر فيها الحكم المستأنف طالباً في ختامها الحكم بـ {{subject}}.
وبتاريخ {{trigger_date}} قضت المحكمة بحكم مجحف بحقوق المستأنف.

أسباب الاستئناف:
أولاً: الخطأ في تطبيق القانون وتأويله ومخالفة الثابت بالأوراق.
ثانياً: القصور في التسبيب والفساد في الاستدلال والإخلال بحق الدفاع.
ثالثاً: الإجحاف بالطلبات الجازمة للمستأنف وعدم ندب خبير هندسي / حسابي مختص.

بناءً عليه:
أنا المحضر سالف الذكر قد أعلنت المستأنف ضده بصورة من هذه الصحيفة وكلفته بالحضور أمام {{court}} الكائن مقرها بـ {{court_address}} بالجلسة المنعقدة علناً في تمام الساعة التاسعة صباحاً وما بعدها من يوم {{day_name}} الموافق {{next_hearing_date}} لسماع الحكم بـ:
١. قبول الاستئناف شكلاً لرفعه في الميعاد القانوني.
٢. وفي الموضوع: بإلغاء الحكم المستأنف والقضاء مجدداً برفض الدعوى وإلزام المستأنف ضده بالمصروفات وأتعاب المحاماة عن درجتي التقاضي.
ولأجل العلم ،،،`
    },
    {
      id: "tmpl_2",
      name: "مذكرة دفاع ختامية ورد على الدفوع",
      category: "مذكرات دفاع",
      court_level: "أول درجة واستئناف",
      description: "مذكرة دفاع ختامية مع تأصيل الدفوع الموضوعية وحافظة المستندات القاطعة.",
      template_content: `مذكرة بدفاع
مقدمة إلى عدالة الدائرة: {{circuit}}
بـ {{court}}
بدفاع السيد / {{client_name}} (صفته: المدعي / المستأنف)
ضـد السيد / {{opponent_name}} (صفته: المدعى عليه / المستأنف ضده)
في الدعوى رقم: {{case_number}}
والمحدد لنظرها جلسة: {{next_hearing_date}}

الموضوع:
{{subject}}

الدفوع القانونية والموضوعية:
١. الدفع بعدم جواز نظر الدعوى لسابقة الفصل فيها عملاً بالمادة ١٠١ من قانون الإثبات.
٢. الدفع بسقوط الحق في المطالبة بالتقادم الحولي / الخمسي طبقاً لأحكام القانون المدني.
٣. انتفاء أركان المسؤولية العقدية وثبوت القوة القاهرة والسبب الأجنبي الذي يعفي الموكل من أي التزام تعويضي.

الطلبات الختامية:
يلتمس دفاع المدعي / المستأنف من عدالة المحكمة الموقرة:
أصلياً: الحكم برفض الدعوى وإلزام رافعها بالمصروفات ومقابل أتعاب المحاماة.
احتياطياً: إعادة الدعوى لمكتب خبراء وزارة العدل لمباشرة المأمورية في ضوء المستندات القاطعة المودعة بحافظة مستنداتنا.
والله ولي التوفيق ،،،
وكيل الدفاع: {{assigned_to}} المحامي`
    },
    {
      id: "tmpl_3",
      name: "إنذار رسمي على يد محضر بتنفيذ التزام عقدي",
      category: "إنذارات ومحررات",
      court_level: "محاضر وإجراءات",
      description: "إنذار رسمي يثبت حالة الامتناع ويقطع التقادم ويشغل الفوائد التأخيرية القانونية.",
      template_content: `إنه في يوم {{day_name}} الموافق {{date}}
بناءً على طلب السيد / {{client_name}}، ومحله المختار مكتب الأستاذ / {{assigned_to}} المحامي.

أنا _________ محضر محكمة _________ قد انتقلت إلى حيث موطن:
السيد / {{opponent_name}}
مخاطباً مع / ________________________________________________

وأنذرته بالآتي:
بموجب عقد الاتفاق المبرم بين المنذر والمنذر إليه، ترصد في ذمة المنذر إليه مبلغ وقدره {{claim_amount}} مقابل {{subject}}.
وحيث إنه قد حل أجل الوفاء وامتنع المنذر إليه دون مسوغ قانوني رغم تكرار المطالبات الودية.

لذلك:
فإن المنذر ينذر المنذر إليه رسمياً بسرعة سداد المبلغ سالف البيان وفوائده القانونية بواقع ٥٪ سنوياً، وذلك خلال مهلة غايتها خمسة عشر يوماً من تاريخ إعلان هذا الإنذار، وإلا سيضطر المنذر إلى اتخاذ كافة الإجراءات القضائية وتوقيع الحجوزات التحفظية والتنفيذية مع حفظ كافة حقوق المنذر الأخرى من عطل وضرر ومصروفات.
ولأجل العلم ،،،`
    },
    {
      id: "tmpl_4",
      name: "طلب تأجيل للاطلاع والمستندات وسداد الأمانة",
      category: "طلبات وعرائض",
      court_level: "كافة المحاكم",
      description: "طلب رسمي يقدم لرئيس الدائرة للتأجيل لإعادة الإعلان أو الاطلاع وسداد الأمانة.",
      template_content: `السيد الأستاذ المستشار / رئيس الدائرة {{circuit}}
بـ {{court}}
تحية طيبة وبعد ،،،

مقدمه لسيادتكم الأستاذ / {{assigned_to}} المحامي، وكيلاً عن:
السيد / {{client_name}}
في الدعوى رقم: {{case_number}}
المحدد لنظرها جلسة: {{next_hearing_date}}

برجاء التكرم بالموافقة على تأجيل نظر الدعوى لأجل مناسب وذلك لـ:
[  ] للاطلاع على المذكرة والمستندات المقدمة بجلسة اليوم من الخصم والرد عليها.
[  ] لإعادة إعلان المدعى عليه بالصفة الصحيحة قانوناً.
[  ] لضم المفردات / إيداع أمانة الخبير المقضي بها تمهيدياً.

وتفضلوا بقبول فائق التقدير والاحترام ،،،
مقدمه لعدالتكم: {{assigned_to}} المحامي`
    }
  ]
};
